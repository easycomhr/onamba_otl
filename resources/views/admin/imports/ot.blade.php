...
@section('title', 'Import OT (Excel)')
@section('page_title', 'Import OT')

@section('content')
<h1 class="text-2xl font-extrabold text-gray-900 uppercase tracking-tight mb-6 hidden md:block">Import OT (Excel)</h1>
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex items-start">
        ...
        <div>
            <p class="text-blue-800 font-semibold mb-1">Hướng dẫn import:</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-gray-50 px-5 py-4 border-b border-gray-200">
            <h2 class="text-[17px] font-bold text-gray-800 uppercase">Tải lên file OT</h2>
        </div>
